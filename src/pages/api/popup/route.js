...
export default async function POST(req, res) {
    try {
        const { name, email, phone, services, message } = await req.body;
        ...
        return res.json({ "message": "Email send sucessfully", "data": [name, email, phone, services, message], "status": 200 });
    } catch (error) {
