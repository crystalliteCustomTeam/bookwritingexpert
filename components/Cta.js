...
const Cta = ({
    title = ` Access Our <span class='color-blue fw700 hover textdocationnone' href='/book-publishing-services'> Book Writers </span>at Your Fingertips`,
                    ...
                    <Row className={` ${styles.middle} gy-4`}>
                        <Col md={12}>
                            <div className={styles.dowemargin}>
                                <h2 className="fw300 font50 text-white font-f mb-4" dangerouslySetInnerHTML={{ __html: title }} />
                                <p className='font15 fw400 font-f text-white pe-lg-5 pe-0' dangerouslySetInnerHTML={{ __html: desc }} />

                                <div className='mt-5'>

                                    <Link className={styles.btn1} href="javascript:void(Tawk_API.toggle())">Chat With Our Expert Now!</Link>
